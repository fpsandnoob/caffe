...
class_name = os.listdir(main_path)
class_dict = {}
...
class Data:
    def __init__(self):
        ...
        self.data_path_dir = os.listdir(main_path)

    def get_img(self):
        for dir_path in self.data_path_dir[0:3]:
            p = os.listdir("/home/fpsandnoob/image_output/" + dir_path)
            for im in p:
                self.data.append(cv2.resize(cv2.imread(os.path.join("/home/fpsandnoob/image_output/" + dir_path, im)),
                                            (227, 227)))
